...
def git_clone():
    '''Cloning a repository with clamav databases'''
    command_clone = "curl -LSOs https://github.com/ladar/clamav-data/raw/main/main.cvd.[01-10] \
    ...
    command_generate_main = "cat main.cvd.01 main.cvd.02 main.cvd.03 main.cvd.04 main.cvd.05 \
    ...
    command_generate_daily = "cat daily.cvd.01 daily.cvd.02 daily.cvd.03 daily.cvd.04 daily.cvd.05 \
    ...
    command_generate_full = "sha256sum -c main.cvd.sha256 daily.cvd.sha256 bytecode.cvd.sha256 && \
...
def remove_cvd():
    '''Remove old clamav databases'''
    os.system("rm -f /home/app-user/clamav-data/bytecode.cvd &&  \
            rm -f /home/app-user/clamav-data/main.cvd &&  \
            rm -f /home/app-user/clamav-data/daily.cvd")
